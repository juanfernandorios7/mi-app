...
export default function Formacion({ initialCursos, initialSesiones, config, onDataChange, timer }: FormacionProps) {
  ...
  return (
    <div className="fade-up">
      ...
      {/* ── Métricas ── */}
      <div style={{
        background: "#261d14", border: "1px solid #3d3028",
        ...
        <div style={{ height: 5, background: "#38291e", borderRadius: 4, marginBottom: 14, overflow: "hidden" }}>
          <div style={{
      ...
      {cursos.length === 0 ? (
        <div style={{
          ...
          border: "1px dashed #3d3028", borderRadius: 16,
        }}>
          ...
          {cursos.map(curso => {
            ...
            return (
              <div key={curso.id} style={{
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                        ...
                        <span style={{
                          ...
                          background: curso.estado === "completado" ? "#7c9e6e18" : curso.estado === "pausado" ? "#38291e" : curso.color + "18",
                          border: "1px solid " + (curso.estado === "completado" ? "#7c9e6e44" : curso.estado === "pausado" ? "#4e4038" : curso.color + "44"),
                ...
                {/* ── Sesiones expandidas ── */}
                {isExpanded && (
                  <div style={{ borderTop: "1px solid #38291e", padding: "12px 20px 16px" }}>
                            ...
                            <div key={sesion.id}>
                              <div style={{
                                ...
                                <button
                                  ...
                                  style={{
                                    background: isTracking ? curso.color + "22" : "#38291e",
                                    border: "1px solid " + (isTracking ? curso.color : "#4e4038"),
                    ...
                    {addingSesionFor === curso.id ? (
                      <div style={{
                        background: "#2a2018", border: "1px solid #4e4038",
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                          <input
                            ...
                            style={{
                              background: "#261d14", border: "1px solid #4e4038", borderRadius: 8,
                          ...
                          <div style={{ display: "flex", gap: 8 }}>
                            <button
                              ...
                              style={{
                                background: !newSesion.titulo.trim() ? "#38291e" : curso.color + "22",
                                border: "1px solid " + (!newSesion.titulo.trim() ? "#4e4038" : curso.color + "66"),
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: "1px dashed #4e4038", borderRadius: 10,
                          color: "#555", padding: "8px 0",
                          fontSize: 12, fontFamily: "'Syne', sans-serif", fontWeight: 600,
                          marginTop: 4,
                        }}
                        onMouseEnter={e => { (e.currentTarget).style.borderColor = "#5e5048"; (e.currentTarget).style.color = "#777"; }}
                        onMouseLeave={e => { (e.currentTarget).style.borderColor = "#4e4038"; (e.currentTarget).style.color = "#555"; }}
                      >
                        + Nueva sesión
                      </button>
                    )}
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 24 }}>
              <button
                ...
                style={{
                  background: saving || !newCurso.nombre.trim() ? "#4e4038" : ACCENT,
                  border: "none",
                  color: saving || !newCurso.nombre.trim() ? "#555" : "#1c1510",
